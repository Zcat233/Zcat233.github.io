...
现在这个网站主要用于记录生活碎片，也没啥特别的啦～

本站点对原博客项目做出了少量修改，同时兼容Hux Blog。

深色功能是Zcat自己vibe coding出来的，还有不少bug，勉强用吧。
...
| 仓库       | [https://github.com/Huxpro/huxpro.github.io](https://github.com/Huxpro/huxpro.github.io) |
...
这里有一些文章是我从网上复制过来的。如果构成侵权，请联系我删除。
...
**代码部分**使用 **Apache License 2.0** 许可证。

**博客文章、图片、文字等内容部分**使用 **CC BY-NC-ND 4.0** 许可证。

简而言之，除非特殊注明，否则在转载或改编原创内容部分前，请先通过 [mailto:zcat336886@outlook.com] 联系Zcat233。
