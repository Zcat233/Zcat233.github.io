...
---
#### 这里不是markdown
<span style="color:red;">甲</span> <span style="color:orange;">乙</span> <span style="color:coral;">丙</span> <span style="color:gold;">丁</span> <span style="color:MediumSeaGreen;">戊</span> <span style="color:DeepSkyBlue;">己</span> <span style="color:SlateBlue;">庚</span> <span style="color:purple;">新</span> <span style="color:violet;">壬</span> <span style="color:pink;">癸</span> 
...
<iframe 
    src="https://beizhedenglong.github.io/weird-fonts/" 
    title="背着灯笼！"
    width="100%" 
    height="600px" 
    frameborder="0"
...
这是最近的一张[必应壁纸](https://peapix.com/bing)。（当然是指当时的最近啦……）
...
<audio controls>
    <source src="https://github.com/Zcat233/Raw-Files/raw/main/Zcat-Blog/达拉崩吧.mp3" type="audio/mpeg">
    您的浏览器不支持 audio 元素。
</audio>
